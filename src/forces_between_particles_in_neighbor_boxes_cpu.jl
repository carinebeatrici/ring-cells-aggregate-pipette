...
function forces_between_particles_in_neighbor_boxes(force_particle_x,
                force_particle_y, x_positions, y_positions, matrix_list_particles,
                num_boxes, box_around, counter, ring_particle_is_from, R0,
                l_adhesion,  k_adhesion, k_core, particles_per_ring, num_neighbors)
